import { blocks, configurationFileNames, functionExtensions, themeExtensions, uiExtensions, getUIExtensionRendererDependency, dotEnvFileNames, } from '../../constants.js';
import { dependency, error, file, id, path, schema, string, toml, output } from '@shopify/cli-kit';
import { readAndParseDotEnv, writeDotEnv } from '@shopify/cli-kit/node/dot-env';
 ...
 */
export async function updateDependencies(app) {
...
export function hasExtensions(app) {
