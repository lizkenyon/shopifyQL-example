...
export function getArtifactName(options) {
...
export function getReleaseArtifactURL({ name, extension }) {
    return `${RELEASE_DOWNLOADS_URL}/${versions.extensionsBinary}/${name}.${extension}`;
}
export function validatePlatformSupport({ platform, arch }) {
...
export async function ensureBinaryDirectoryExists() {
...
export async function getBinaryLocalPath() {
    const { platform, arch } = os.platformAndArch();
